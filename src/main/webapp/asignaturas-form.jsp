...
<html>
<head>
<title>Insertar / Actualizar  Asignaturas</title>
</head>
<body>
<header>
<div class="header">
		...
		<div>
			<div>
				<c:if test="${asignaturas != null}">
					<form action="updatea" method="post" class="formulario">
				</c:if>
				<c:if test="${asignaturas == null}">
					<form action="inserta" method="post" class="formulario">
				</c:if>
				<caption>
					<h3>
						<c:if test="${asignaturas != null}">EDITAR ASIGNATURA</c:if>
						<c:if test="${asignaturas == null}">INSERTAR NUEVA ASIGNATURA</c:if>
					</h3>
				</caption>
				<c:if test="${asignaturas != null}">
					<input type="hidden" name="id" value="<c:out value='${asignaturas.id}' />" >
				</c:if>
				<fieldset>
					<legend>NOMBRE ASIGNATURA</legend>
					<input type="text" value="<c:out value='${asignaturas.name}' />"
