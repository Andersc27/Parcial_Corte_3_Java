...
<a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
	...
	<div class="row">
		...
		<div class="container">
			<h3 class="text-center">LISTA DE COLEGIOS</h3>
			<hr>
			<br>
			<center><div class="boton">
				
					<a href="<%=request.getContextPath()%>/newc" class="href"
						title="INSERTAR NUEVO
					COLEGIO"> <svg class="w-6 h-6" fill="none" stroke="currentColor" color="green" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="50" height="50"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
