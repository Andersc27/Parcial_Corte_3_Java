...
<html>
<head>
<title>Insertar / Actualizar  Profesores</title>
</head>
<body>
<header>
<div class="header">
...
<a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
	...
	<div>
		<div>
			<div>
				<c:if test="${profesores != null}">
					<form action="updatep" method="post" class="formulario">
					<h3>EDITAR PROFESOR</h3>
				<fieldset>
					<legend>ID</legend>
					<input type="number" value="<c:out value='${profesores.id}' />"
						class="form-control" name="id" required="required" readonly>
				</fieldset>
				</c:if>
				<c:if test="${profesores == null}">
					<form action="insertp" method="post" class="formulario">
					<h3>INSERTAR NUEVO PROFESOR</h3>
				<fieldset>
					<legend>NÚMERO DE DOCUMENTO</legend>
					<input type="number" value="<c:out value='${profesores.id}' />"
				...
				<fieldset>
					<legend>NOMBRE PROFESOR</legend>
					<input type="text" value="<c:out value='${profesores.name}' />"
						class="form-control" name="name" required="required">
				</fieldset>
				<fieldset>
					<legend>TELEFONO PROFESOR</legend>
					<input type="number" value="<c:out value='${profesores.telefono}' />"
						class="form-control" name="telefono" required="required">
				</fieldset>
				<fieldset>
					<legend>EMAIL PROFESOR</legend>
					<input type="email" value="<c:out value='${profesores.email}' />"
				...
				<fieldset>
					...
					<select name="idasig" id="idasig">
						<!-- for (Todo todo: todos) { -->
						<c:forEach var="asignatura" items="${listAsignaturas}">
							<option value="<c:out value="${asignatura.id}" />"> ${asignatura.name}</option>
						</c:forEach>
						<!-- } -->
					</select>
				</fieldset>
				<fieldset>
					...
					<input type="text" value="<c:out value='${profesores.dias}' />"
						class="form-control" name="dias" required="required">
				</fieldset>
				<br>
